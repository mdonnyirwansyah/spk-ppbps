...
class SubCriteriaSeeder extends Seeder
{
    ...
    public function run()
    {
        $sub_criteria = collect([
            ['criteria_id' => 1, 'name' => '18-24', 'rating' => 'Sangat Rendah', 'weight' => 1],
            ...
            ['criteria_id' => 1, 'name' => '>=43', 'rating' => 'Sangat Tinggi', 'weight' => 5],
            ['criteria_id' => 2, 'name' => 'Tamat SLTP/Sederajat', 'rating' => 'Sangat Rendah', 'weight' => 1],
            ...
            ['criteria_id' => 4, 'name' => '>=91', 'rating' => 'Sangat Tinggi', 'weight' => 5]
        ]);
